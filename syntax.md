Mermaid-like Syntax for Digital Pattern Generator (gen3.py)

This document outlines the keywords and syntax used in the input file for gen3.py. The file defines blocks of operations, their configurations, and the logical flow between them.
...
(Identified by block_id starting with "control". Content within controlXYZ [...])
    ...
    dacstatic <ch:val> [<ch:val> ...]
        ...
        <ch:val>: E.g., 0:1.0V, 1:2000. Values can be integers or voltage strings.
